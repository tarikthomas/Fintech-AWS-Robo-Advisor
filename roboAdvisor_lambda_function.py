...
def validate_data(age, inv_amount, intent_request):
    """
...
# Gets slots' values
    ...
    if risk_level == "Very Low":
        ...
        initial_recommendation = "sorry there has been an error in calculations"
